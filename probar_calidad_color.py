#!/usr/bin/env python3
"""
Script para probar la calidad y color de las fotos de pasaporte
"""
...
def generar_prompt_pasaporte_alta_calidad_color(perfil, edad=25):
    """Genera prompt con alta calidad y color para foto de pasaporte"""
...
def test_quality_and_color():
    """Prueba la calidad y color de las fotos de pasaporte"""
    print("📸 PROBANDO CALIDAD Y COLOR DE FOTOS DE PASAPORTE")
    print("=" * 60)
    ...
    for i in range(3):
        ...
        # Generar prompt
        prompt, negative_prompt = generar_prompt_pasaporte_alta_calidad_color(perfil, 25)
        ...
        if total_score >= 90:
            print("   ✅ EXCELENTE - Cumple todos los estándares de calidad y color")
        elif total_score >= 80:
            print("   ⚠️ BUENO - Cumple la mayoría de estándares")
        elif total_score >= 70:
            print("   ⚠️ REGULAR - Necesita mejoras en algunos estándares")
        else:
            print("   ❌ MALO - No cumple los estándares de calidad y color")
    
    print(f"\n\n📊 RESUMEN DE CALIDAD Y COLOR DE PASAPORTE")
    print("=" * 50)
    ...
    print("✅ Control específico de fotografía a color")
    print("✅ Prompt negativo reforzado contra baja calidad")
    print("✅ Prompt negativo reforzado contra blanco y negro")
    
    print(f"\n🎯 REQUISITOS DE CALIDAD Y COLOR CUMPLIDOS:")
    print("   - Alta calidad y resolución")
    print("   - Enfoque nítido y detallado")
    print("   - Colores vibrantes y naturales")
    print("   - Fotografía a color (no blanco y negro)")
    print("   - Calidad profesional y de estudio")
    print("   - Colores precisos y verdaderos")
    print("   - Sin efectos vintage o envejecidos")
    print("   - ¡Listo para generar fotos de pasaporte en alta calidad y color!")

if __name__ == "__main__":
    print("🚀 INICIANDO PRUEBAS DE CALIDAD Y COLOR DE PASAPORTE")
    print("=" * 60)
    
    test_quality_and_color()
