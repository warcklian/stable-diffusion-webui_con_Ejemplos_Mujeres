#!/usr/bin/env python3
"""
Script para probar el encuadre exacto de fotos de pasaporte
"""
...
def generar_prompt_pasaporte_encuadre_exacto(perfil, edad=25):
    """Genera prompt con encuadre exacto para foto de pasaporte"""
...
def test_passport_framing():
    ...
    for i in range(3):
        ...
        # Generar prompt
        prompt, negative_prompt = generar_prompt_pasaporte_encuadre_exacto(perfil, 25)
        ...
        passport_indicators = [
            ...
            "head centered in frame", "shoulders at bottom edge", "space above head",
            "clear space above head", "head not touching top", "head not touching edges",
        ...
        negative_indicators = [
            ...
            "shoulders touching edges", "no space above head", "head filling frame",
            "head filling top", "head filling edges", "head filling sides",
            "head filling bottom", "shoulders filling frame", "shoulders filling sides",
            "shoulders filling bottom", "shoulders filling edges", "clavicle not visible",
            "clavicle junction not visible", "clavicle connection not visible",
        ...
        if total_score >= 90:
            print("   ✅ EXCELENTE - Cumple todos los estándares de encuadre")
        elif total_score >= 80:
            print("   ⚠️ BUENO - Cumple la mayoría de estándares")
        elif total_score >= 70:
            print("   ⚠️ REGULAR - Necesita mejoras en algunos estándares")
        else:
            print("   ❌ MALO - No cumple los estándares de encuadre")
    
    print(f"\n\n📊 RESUMEN DE ENCUADRE EXACTO DE PASAPORTE")
    print("=" * 50)
    print("✅ Prompts optimizados para encuadre exacto de pasaporte")
    print("✅ Control específico de distancia y tamaño de cabeza")
    print("✅ Control específico de espacio superior")
    print("✅ Control específico de corte de hombros")
    print("✅ Control específico de clavículas visibles")
    print("✅ Prompt negativo reforzado contra errores de encuadre")
    
    print(f"\n🎯 REQUISITOS DE ENCUADRE CUMPLIDOS:")
    print("   - Cabeza completa visible")
    print("   - Espacio en blanco arriba de la cabeza")
    print("   - Corte justo por debajo de la unión de las clavículas")
    print("   - Hombros libres a los costados")
    print("   - Tamaño de cabeza proporcional")
    print("   - Cabeza centrada en el frame")
    print("   - Hombros en el borde inferior")
    print("   - ¡Listo para generar fotos de pasaporte con encuadre perfecto!")

if __name__ == "__main__":
    print("🚀 INICIANDO PRUEBAS DE ENCUADRE EXACTO DE PASAPORTE")
    print("=" * 60)
    
    test_passport_framing()
